...
namespace SabreTools.Serialization.Wrappers
{
    public partial class XMID : WrapperBase<Data.Models.Xbox.XMID>
    {
        ...
        /// <inheritdoc/>
        public XMID(Data.Models.Xbox.XMID model, byte[] data) : base(model, data) { }

        /// <inheritdoc/>
        public XMID(Data.Models.Xbox.XMID model, byte[] data, int offset) : base(model, data, offset) { }

        /// <inheritdoc/>
        public XMID(Data.Models.Xbox.XMID model, byte[] data, int offset, int length) : base(model, data, offset, length) { }

        /// <inheritdoc/>
        public XMID(Data.Models.Xbox.XMID model, Stream data) : base(model, data) { }

        /// <inheritdoc/>
        public XMID(Data.Models.Xbox.XMID model, Stream data, long offset) : base(model, data, offset) { }

        /// <inheritdoc/>
        public XMID(Data.Models.Xbox.XMID model, Stream data, long offset, long length) : base(model, data, offset, length) { }
