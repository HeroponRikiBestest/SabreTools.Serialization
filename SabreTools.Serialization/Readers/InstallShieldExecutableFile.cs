...
// a singular, large MSI installer along with some helper files, whereas plain executables often (if not always?) mainly
// consist of regular installshield cabinets within.
// At the moment, this code only supports and documents the plain variant. Clearer naming and separation between the
